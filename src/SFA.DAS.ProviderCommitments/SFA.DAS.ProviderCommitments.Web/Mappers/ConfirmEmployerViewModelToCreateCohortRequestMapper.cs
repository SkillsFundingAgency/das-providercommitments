...
{
    public class ConfirmEmployerViewModelToCreateCohortRequestMapper : IMapper<ConfirmEmployerViewModel, CreateCohortRequest>
    {
        private readonly ICommitmentsApiClient _commitmentsApiClient;

        public ConfirmEmployerViewModelToCreateCohortRequestMapper(ICommitmentsApiClient commitmentsApiClient)
        {
            _commitmentsApiClient = commitmentsApiClient;
        }

        public async Task<CreateCohortRequest> Map(ConfirmEmployerViewModel source)
        {

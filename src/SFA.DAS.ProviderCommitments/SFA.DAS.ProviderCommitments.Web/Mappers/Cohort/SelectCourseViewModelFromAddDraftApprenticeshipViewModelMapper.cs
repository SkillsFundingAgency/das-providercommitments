...
namespace SFA.DAS.ProviderCommitments.Web.Mappers.Cohort
{
    public class SelectCourseViewModelFromAddDraftApprenticeshipViewModelMapper : IMapper<AddDraftApprenticeshipViewModel, SelectCourseViewModel>
    {
        ...
        public SelectCourseViewModelFromAddDraftApprenticeshipViewModelMapper(ICommitmentsApiClient commitmentsApiClient, IMediator mediator)
        {
            _commitmentsApiClient = commitmentsApiClient;
            _mediator = mediator;
        }

        public async Task<SelectCourseViewModel> Map(AddDraftApprenticeshipViewModel source)
        {

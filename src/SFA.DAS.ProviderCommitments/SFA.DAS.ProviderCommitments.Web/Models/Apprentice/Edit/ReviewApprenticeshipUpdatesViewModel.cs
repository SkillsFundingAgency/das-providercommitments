...
{
    public class ReviewApprenticeshipUpdatesViewModel : IApprenticeshipUpdatesViewModel, IAuthorizationContextModel
    {
        public bool? ApproveChanges { get; set; }
        public bool? ApproveAddStandardToTraining { get; set; }
        public bool IsValidCourseCode { get; set; }
        [FromRoute] public long ProviderId { get; set; }
        [FromRoute] public string ApprenticeshipHashedId { get; set; }
        [JsonIgnore] public long ApprenticeshipId { get; set; }

...
{
    //TODO: Review
    public class StubProviderRelationshipsApiClient2 : IProviderRelationshipsApiClient
    {
        private readonly HttpClient _httpClient;

        public StubProviderRelationshipsApiClient2()
        {
            _httpClient = new HttpClient { BaseAddress = new System.Uri("http://localhost:3205/provider-relationships/api") };
        }

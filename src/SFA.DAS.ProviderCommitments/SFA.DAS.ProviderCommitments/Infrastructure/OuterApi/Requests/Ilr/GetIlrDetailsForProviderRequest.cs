...
{
    public class GetIlrDetailsForProviderRequest : IGetApiRequest
    {
        public long ProviderId { get; set; }

        public GetIlrDetailsForProviderRequest(long providerId, long cohortId, long draftApprenticeshipId)
        {

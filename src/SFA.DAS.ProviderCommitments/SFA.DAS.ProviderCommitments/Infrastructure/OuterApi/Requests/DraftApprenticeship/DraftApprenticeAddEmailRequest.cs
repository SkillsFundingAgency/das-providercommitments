...
public class DraftApprenticeAddEmailRequest(long providerId, long cohortId, long draftApprenticeshipId) : IPutApiRequest
{
    ...
    public string PutUrl => $"provider/{ProviderId}/unapproved/{CohortId}/apprentices/{DraftApprenticeshipId}/email";

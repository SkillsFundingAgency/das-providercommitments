...
{
    public class ValidateSelectMultipleLearnerRecordsHandler : IRequestHandler<ValidateSelectMultipleLearnerRecordsRequest, ValidateSelectMultipleLearnerRecordsResponse>
    {
        ...
        public ValidateSelectMultipleLearnerRecordsHandler(IOuterApiService client, IModelMapper modelMapper, IBulkUploadFileParser bulkUploadFileParser, IAuthorizationService authorizationService)
        {
            _client = client;

...
[TestFixture]
public class WhenGettingSelectHowManyLearnersToAdd
{
    [Test]
...
public class WhenGettingSelectHowManyLearnersToAddFixture
{
    ...
    public WhenGettingSelectHowManyLearnersToAddFixture()
    {
    ...
    public IActionResult Act() => Sut.SelectHowManyLearnersToAdd(_request);
}
...
[TestFixture]
public class AddDraftApprenticeshipEmailViewModelMapperTests
{
    ...
    public void Setup()
    {
        ...
        _mapper = new AddDraftApprenticeshipEmailViewModelMapper(_apiClient.Object);
    }
    ...
    [Test]
    public async Task OriginalEmail_Is_Mapped_Correctly()
    {
        var result = await _mapper.Map(_request);
        result.OriginalEmail.Should().Be(_apiResponse.Email);
    }

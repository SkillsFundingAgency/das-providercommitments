...
namespace SFA.DAS.ProviderCommitments.Web.UnitTests.Mappers.Apprentice
{
    ...
    public class DetailsViewModelMapperTests
    {
        ...
        {
            await _fixture.Map();
            Assert.AreEqual(_fixture.PriceEpisodesApiResponse.PriceEpisodes.First().Tr, _fixture.Result.TrainingPrice);
        }

        [Test]
        public async Task ThenAssessmentPriceIsMappedCorrectly()
        {
            await _fixture.Map();
            Assert.AreEqual(_fixture.PriceEpisodesApiResponse.PriceEpisodes.First().Tr, _fixture.Result.EndPointAssessmentPrice);
        }
        ...
        {
            await _fixture.Map();
            Assert.AreEqual(_fixture.ApiResponse.DeliveryModel, _fixture.Result.DeliveryModel);
        }

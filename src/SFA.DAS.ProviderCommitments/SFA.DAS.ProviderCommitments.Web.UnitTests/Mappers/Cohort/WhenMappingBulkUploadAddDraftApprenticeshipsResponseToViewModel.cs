...
public class WhenMappingBulkUploadAddDraftApprenticeshipsResponseToViewModelFixture
{
    ...
    public void VerifyEmployerNameIsMappedCorrectly()
    {
        ...
        viewModelEmployerName.Should().Be(responseEmployerName);
    }
    ...
    {            
        ...
        viewModelCohortReference.Should().Be(responseCohortReference);
    }
    ...
    {           
        ...
        viewModelnumberOfApprenticeships.Should().Be(responsenumberOfApprenticeships);
    }

    internal void VerifyCorrectNumberOfEmployersAreMapped()
    {
        _result.BulkUploadDraftApprenticeshipsViewModel.Count.Should().Be(3);
    }
}